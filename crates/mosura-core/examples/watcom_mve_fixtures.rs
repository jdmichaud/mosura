...
fn main() {
    ...
    for m in mosura_core::recompile::mve::MVES {
        ...
        let (code_names, data_names) = mosura_core::recompile::mve::extern_kinds(src);
        ...
        if !cand.tables.is_empty() {
            ...
            let entries = |t: &mosura_core::recompile::candidate::CandTable| -> Vec<u8> {
