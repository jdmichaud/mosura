...
fn sbb_template_renders_signed_division() {
    ...
    let recovered = RecoveredChoices { sdiv_pow2: mosura_core::decompile::emit::arms::sdiv_pow2::Sites { sites: [0x600e].into_iter().collect(), ..Default::default() }, ..Default::default() };
