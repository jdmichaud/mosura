...
//!
//! Run: `cargo test --release -p mosura-core --test mve_twin_build -- --ignored`
//!
...
use mosura_core::recompile::mve::MVES;
use mosura_core::recompile::twin::twin;
...
fn every_arm_rendering_of_an_mve_behaves_as_its_source() {
    let workdir = mosura_core::paths::workspace_root().join("build/mve-twin");
