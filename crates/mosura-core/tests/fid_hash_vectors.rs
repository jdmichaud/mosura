...
use mosura_core::lang;
use mosura_core::sleigh::InstructionFingerprint;
...
fn hash_body(bytes: &[u8], relocations: &dyn RelocationQuery) -> Option<mosura_core::analysis::fid::hash::FidHashQuad> {
