...
fn under_sized_frame_declares_one_aggregate_with_field_offsets() {
    ...
    let recovered = RecoveredChoices { frame_fill: mosura_core::decompile::emit::arms::frame_fill::Sites { frame: Some((0xd0, 2)), ..Default::default() }, ..Default::default() };
...
fn swallowed_symbol_elements_render_as_fields() {
    ...
    let recovered = RecoveredChoices { frame_fill: mosura_core::decompile::emit::arms::frame_fill::Sites { frame: Some((0xcc, 4)), ..Default::default() }, ..Default::default() };
    let c = print_c_recovered(&f, &choices, &recovered);
