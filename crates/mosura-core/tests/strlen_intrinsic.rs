...
fn repne_scasb_renders_strlen() {
    ...
    let recovered = RecoveredChoices { string_ops: mosura_core::decompile::emit::arms::string_ops::Sites { sites: [0x600a].into_iter().collect(), ..Default::default() }, ..Default::default() };
