...
fn render(fixture: &str) -> (String, String) {
    ...
    let recovered = RecoveredChoices { struct_copy: mosura_core::decompile::emit::arms::struct_copy::Sites { runs: mosura_core::recompile::buildconfig::movsd_runs_from_evidence(&insns), ..Default::default() }, ..Default::default() };
