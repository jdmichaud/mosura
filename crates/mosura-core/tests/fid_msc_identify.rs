...
fn microsoft_c_16bit_runtime_is_identified() {
    let path = mosura_core::paths::msc16_exe();
    ...
    let id = mosura_core::analysis::loader::compiler_version::detect(&data)
    ...
    let service = mosura_core::analysis::fid::query::FidQueryService::load_matching_all(
        &mosura_core::paths::fid_db_dirs(),
        &program.language_id,
