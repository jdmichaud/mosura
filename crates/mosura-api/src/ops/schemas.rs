...
pub static EQUIV: Schema = Schema { name: "equiv", version: 1, columns: &[C::new("idx", T::Str), C::hex("va", T::U64), C::new("name", T::Str), C::new("verdict", T::Str), C::new("seeds", T::U64), C::new("finished", T::U64), C::new("traces", T::U64), C::new("agreed", T::U64), C::new("faults", T::U64), C::new("detail", T::Str)] };
