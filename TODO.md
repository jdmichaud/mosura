...
Decompiler corpus: **0.756 avg structural similarity to Ghidra, 51/62 x86-64 datatests
decompiled, 34 ≥ 0.70.** `cargo test` green; **254/254 disasm/p-code parity**; datatest
ratchet in `crates/mosura/tests/datatest_score.rs` (avg ≥ 0.75, good ≥ 33).
