...
instruction; the operand lists did not:
    ...
    the subject     MOV AL,[EAX + 0x8ef18]  ops = [Register(0), Scalar(585496)]
...
segment-relative as well as self-relative, plus GRPDEF and target THREADs. the subject **120 → 130
...
Related: (subject-profile note `crt-identified-by-omf-lib-search`), [[fid-port-track]],
