...
**Why:** re-querying freshly each time invented WAR2 functions at three shared epilogues
...
why WAR2 `FUN_00067f40` is still not recovered — its fresh `function_before(0x69032)` = 0x68f25
...
Related: [[reftype-is-post-override-not-the-instruction]], [[war2-tailjmp-mve]].
