 ...
 * watprog. It is the source-reduced repro of the unrecovered the subject binary protected-mode switch
 * dispatches (`le_subjects_analysis`, sites 0x513a8 / 0x58afb / 0x6af52 / 0x199b7): a dense `switch`
 ...
 * the table index — the exact shape the subject emits (`AND EAX,0xffff` / `AND EAX,0xff`) for a
 ...
 * docs/decompiler-bug-narrow-switch.md. The CS: segment prefix the subject carries is NOT the cause —
